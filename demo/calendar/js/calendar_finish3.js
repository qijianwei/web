window.onload=function(){
				...
				var M=nowMonth;
				var notearr=[];
				var oSuolue=document.querySelector(".suolue");
				var oZhankai=document.querySelector("#zhankai");
				var timerC;
				//oSuolue
				oZhankai.num=0;
				oSuolue.onclick=function(){
					console.log(oZhankai.num);
					animation(oWeather,{
						opacity:0
					},16,'linear');
					animation(oBk,{
					...
					if (oZhankai.num==0) {
						oCal_wrap.style.overflow='hidden';
						...
						animation(oCal_wrap,{
							...
							animation(oCal_wrap,{
								...
								oZhankai.style.display='block';
								oCal_wrap.style.display='none';
								clearInterval(timerC);
								timerC=setTimeout(function(){
									animation(oZhankai,{
										left:-50
									},200,'linear',function(){
										oZhankai.style.borderRightColor='gold';
									})
								},3000)
								oZhankai.num=1;
							});
				...
				oZhankai.onmouseover=function(){
					oZhankai.style.borderRightColor='black';
					animation(oZhankai,{
						left:0
					},200,'linear',function(){
						oZhankai.num=2;
				...
				oZhankai.onclick=function(){
					if (oZhankai.num==2) {
						oZhankai.style.display='none';
						oCal_wrap.style.display='block';
						animation(oCal_wrap,{
							width:320
						},150,'linear',function(){
							animation(oCal_wrap,{
								...
								oCal_wrap.style.overflow='visible';
								oZhankai.num=0;
								animation(oWeather,{
									opacity:1
								},16,'linear');
